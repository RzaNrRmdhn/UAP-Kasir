...
public class MakananController {
    ...
    @FXML
    private TableColumn<?, ?> ColomnDaya;

    @FXML
    private TableColumn<?, ?> ColomnDiskon;

    @FXML
    private TableColumn<?, ?> ColomnId;

    @FXML
    private TableColumn<?, ?> ColomnJumlah;

    @FXML
    private TableColumn<?, ?> ColomnNama;

    @FXML
    private TableColumn<?, ?> ColomnProduk;
